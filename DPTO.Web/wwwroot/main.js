...
var AppComponent = /** @class */ (function () {
    function AppComponent(http) {
        ...
        this.cars = [];
        this.displayedColumns = ["name", "addedOn"];
        this.carName = "";
    }
    AppComponent.prototype.ngOnInit = function () {
        this.fetchCars();
    };
    AppComponent.prototype.fetchCars = function () {
        var _this = this;
        this.http.get(this.url + "cars").subscribe(function (res) { return _this.cars = res; });
    };
    AppComponent.prototype.addCar = function () {
        var _this = this;
        if (!!this.carName) {
            this.http.post(this.url + "cars", { Name: this.carName }).subscribe(function () { _this.fetchCars(); _this.carName = ""; });
        }
    };
...
module.exports = __webpack_require__(/*! C:\Users\Lyns\source\Private\DPTO.Workshop\DPTO.Web\src\main.ts */"./src/main.ts");
